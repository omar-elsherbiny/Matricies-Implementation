...
def draw_text(letter,x,y,c):
    text=FONT.render(letter,True,(c,c,c))
...
def main():
    ...
    while run:
        ...
        for pnt in rot_pnts:
            ...
            c=71000/(dist+200)-100
            #pyg.draw.circle(SCREEN,(c,c,c),(int(pnt.matrix[0][0]+250),int(-pnt.matrix[1][0]+250)),5)
            draw_text(lightness[round(c*23/255)],int(pnt.matrix[0][0]+250),int(-pnt.matrix[1][0]+250),c/4+375/2)
